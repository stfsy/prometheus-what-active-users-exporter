...
const userSessionsGauge = meter.createObservableGauge('user_sessions_currently_active', {
...
meter.createObservableGauge('each_session_currently_active', {
...
meter.createObservableGauge('up', {
